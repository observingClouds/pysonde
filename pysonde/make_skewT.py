...
def main():
    ...
    skew.shade_cin(pres_vals.metpy.convert_units('hPa').values, T.metpy.convert_units('degC').values, parcel_prof.metpy.convert_units('degC').values)
    skew.shade_cape(pres_vals.metpy.convert_units('hPa').values, T.metpy.convert_units('degC').values, parcel_prof.metpy.convert_units('degC').values)
